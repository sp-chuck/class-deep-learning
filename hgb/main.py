...
def main(args):
    ...
    if args.dataset != 'Freebase':
        ...
        """ 增加一堆的元路径类型
        ['A', 'AP', 'APA', 'APT', 'APV', 'APAP', 'APTP', 'APVP', 'APAPA', 'APAPT', 'APAPV', 'APTPA', 'APTPT', 'APTPV', 'APVPA', 'APVPT', 'APVPV']"""
        for k in keys:
...
def parse_args(args=None):
    ...
    parser.add_argument('--epoch', type=int, default=1500, help='Maxinum number of epochs.')
